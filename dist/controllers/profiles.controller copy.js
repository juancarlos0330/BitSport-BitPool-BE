...
exports.remove = exports.avatar = exports.password = exports.names = exports.index = void 0;
    ...
    User_1.default.findById(req.body.userID).then((user) => {
        if (user) {
            ...
            res.json({
                ...
                token: helpers_1.generateToken(user),
            });
            return;
        }
    });
...
const password = (req, res) => {
    User_1.default.findById(req.body.userID)
        ...
        res.json({
            ...
            token: helpers_1.generateToken(updatedUser),
        });
    })
        .catch((error) => {
        res.json({
